...
const PARTY_ABBR = {
  ...
  'All India Majlis-E-Inquilab-E-Millat':            'AIMEIM',
...
function getPartyAbbr(party) {
  if (PARTY_ABBR[party]) return PARTY_ABBR[party];
  return party.split(' ').map(w => w[0]).join('').toUpperCase().slice(0, 6);
}
